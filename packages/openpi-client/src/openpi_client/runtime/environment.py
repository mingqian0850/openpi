# CN: 实现 environment 的核心逻辑与工具（packages/openpi-client/src/openpi_client/runtime/environment.py）。
# EN: Implements core logic and utilities for environment (packages/openpi-client/src/openpi_client/runtime/environment.py).
