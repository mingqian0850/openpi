# CN: 实现 compute_droid_nonidle_ranges 的核心逻辑与工具（examples/droid/compute_droid_nonidle_ranges.py）。
# EN: Implements core logic and utilities for compute_droid_nonidle_ranges (examples/droid/compute_droid_nonidle_ranges.py).
